"""
handle_missing_values.py — Missing Value Handling using the Strategy Design Pattern
====================================================================================

PURPOSE:
    Cleans missing (NaN) values from a DataFrame before training.
    Uses the **Strategy pattern** to allow switching between different imputation methods.
...
CONTEXT CLASS:
    MissingValueHandler            — Accepts any strategy, calls its handle() method.

USED BY:
    steps/handle_missing_values_step.py  →  default strategy is "mean"
"""
