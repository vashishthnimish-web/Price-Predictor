"""
outlier_detection.py — Outlier Detection & Removal using the Strategy Design Pattern
=====================================================================================

PURPOSE:
    Detects and handles outliers in numerical data so they don't distort model training.
    Uses the **Strategy pattern** to allow different detection algorithms.
...
HANDLING METHODS (in OutlierDetector):
    - "remove"  — Drops all rows that contain at least one outlier.
    - "cap"     — Clips extreme values to the 1st and 99th percentiles.

USED BY:
    steps/outlier_detection_step.py  →  uses ZScoreOutlierDetection with threshold=3
"""
