"""
feature_engineering.py — Feature Transformations using the Strategy Design Pattern
==================================================================================

PURPOSE:
    Transforms raw DataFrame features into forms suitable for model training.
    Uses the **Strategy pattern** so you can swap transformation methods at runtime.
...
CONTEXT CLASS:
    FeatureEngineer        — Accepts any strategy, calls its apply_transformation() method.

USED BY:
    steps/feature_engineering_step.py  →  selects a strategy based on a string parameter
"""
