"""
prediction_service_loader.py — ZenML Step: Find the Running MLflow Prediction Server
======================================================================================
...
USED BY:
    pipelines/deployment_pipeline.py  →  inference_pipeline() calls this to get the
    service handle before sending predictions.

OUTPUT:
    MLFlowDeploymentService — a handle to the running prediction server.
"""
