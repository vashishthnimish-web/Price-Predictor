"""
model_evaluator_step.py — ZenML Step: Evaluate the Trained Model
=================================================================
...
PIPELINE POSITION:  Step 7 of 7 (final step) in the training pipeline.
INPUT:              trained Pipeline, X_test, y_test
OUTPUT:             (metrics_dict, mse_value) — evaluation results
"""
